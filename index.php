  ...
  color: white !important;
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand me-auto" href="#">Lotus Salon</a>
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
             <div class="offcanvas-header">
               <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Más información</h5>
    ...
    <section id="sobre-nosotros" style="padding: 80px 20px; background-color: #f0e5c7;">
        <div class="container">
            ...
            <p style="max-width: 800px; margin: auto; font-size: 18px; line-height: 1.6; color: #14151B;">
                ...
                personal.  
                <br><br>
                Nos especializamos en colorimetría, cortes modernos y servicios 
                de cuidado capilar, utilizando productos de alta calidad para 
                proteger tu cabello y potenciar su belleza natural.  
                <br><br>
                Nuestro objetivo es que disfrutes un momento de relajación mientras 
                transformamos tu look con profesionalismo y dedicación.
            </p>
        </div>
    </section>
